...
export default function PatientInfo() {
  ...
  async function handleAddPatient(evt: React.MouseEvent<HTMLButtonElement>) {
    ...
    try {
      ...
      setSuccess(
        `${resp.first_name} ${resp.last_name} was successfully added. Patient Number is ${resp.id}.`
      );
    ...
    <div className="flex flex-col justify-center items-center p-6">
      ...
      <form className="flex flex-col justify-center">
        <div className="flex flex-col sm:flex-row sm:items-center sm:gap-4">
          <label htmlFor="id" className="w-full sm:w-32 text-left font-bold py-1 md:mb-3">
            Patient No:
          </label>
          <input
            type="text"
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:gap-4">
          <label htmlFor="first_name" className="w-full sm:w-32 text-left font-bold md:mb-3">
            First Name:
          </label>
          <input
            type="text"
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:gap-4">
          <label htmlFor="last_name" className="w-full sm:w-32 text-left font-bold md:mb-3">
            Last Name:
          </label>
          <input
            type="text"
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:gap-4">
          <label htmlFor="street_address" className="w-full sm:w-32 text-left font-bold md:mb-3">
            Street:
          </label>
          <input
            type="text"
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:gap-4">
          <label htmlFor="city" className="w-full sm:w-32 text-left font-bold md:mb-3">
            City:
          </label>
          <input
            type="text"
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:gap-4">
          <label htmlFor="state" className="w-full sm:w-32 text-left font-bold md:mb-3">
            State:
          </label>
          <input
            type="text"
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:gap-4">
          <label htmlFor="country" className="w-full sm:w-32 text-left font-bold md:mb-3">
            Country:
          </label>
          <input
            type="text"
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:gap-4">
          <label htmlFor="telephone" className="w-full sm:w-32 text-left font-bold md:mb-3">
            Telephone:
          </label>
          <input
            type="tel"
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:gap-4">
          <label htmlFor="email" className="w-full sm:w-32 text-left font-bold md:mb-3">
            Contact Email:
          </label>
          <input
            type="email"
        ...
        <div className="flex flex-row justify-center my-8 space-x-4">
          <Button className="bg-sky-500 hover:bg-sky-700" type="submit" onClick={handleAddPatient}>
            Add
          </Button>
          <Button
